	...
	<div class="main">
		<div class="navList">
			<ul>
				...
				<li>
					<a href="safeStock/listSafeStock">安全库存配置</a>
				</li>
				<li>
					<a href="inApply/listInApply">入库申请审批</a>
				</li>
				<li>
					<a href="outApply/listOutApply">出库申请审批</a>
				</li>
				<li>
					<a href="inInternal/listInInternal">内部调入申请</a>
				</li>
				<li>
					<a href="outInternal/listOutInternal">内部调出申请</a>
				</li>
				<li>
					<a href="inStock/listInStock">入库登记</a>
				</li>
				<li>
					<a href="outStock/listOutStock">出库登记</a>
				</li>
			</ul>
