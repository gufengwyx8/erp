...
<div class="container">
	...
	<div class="navList">
		<ul>
			...
			<li>
				<a href="record/listRecord">物流单位档案</a>
			</li>
			<li>
				<a href="quote/listQuote">配送单位申请审批</a>
			</li>
			<li>
				<a href="recommend/listRecommend">配送单位推荐管理</a>
			</li>
			<li>
				<a href="contact/listContact">配送单位联络管理</a>
			</li>
			<li>
				<a href="delivery/listDelivery">客户收货管理</a>
			</li>
		</ul>
